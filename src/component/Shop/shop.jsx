class shope extends Comment {
render(){
    return(
        <>
        <nav className="navbar bg-light" style="background-color: #94b3fd94!important;">
            ...
            <div className="row d-flex justify-content-center align-items-center h-100">
                <div className="col-10">
                    ...
                    <div className="d-flex justify-content-between align-items-center mb-4">
                        <h3 className="fw-normal mb-0 text-black">Keranjang</h3>
                        <div>
                            <p className="mb-0"><span className="text-muted">Sort by:</span> <a href="#!"
                                    className="text-body">price <i className="fas fa-angle-down mt-1"><svg
                        ...
                        <div className="card-body p-4">
                            <div className="row d-flex justify-content-between align-items-center">
                                <div className="col-md-2 col-lg-2 col-xl-2">
                                    <img src="./d6b51a82f92d1b702eb0540c5a5b5893.jpg_720x720q80.jpg"
                                        className="img-fluid rounded-3" alt="Cotton T-shirt"/>
                                </div>
                                <div className="col-md-3 col-lg-3 col-xl-3">
                                    <p className="lead fw-normal mb-2">Sikat Gigi Anak</p>
                                    <p><span className="text-muted">Size: </span> s <span className="text-muted">Color:
                                        </span>pink</p>
                                </div>
                                ...
                                <div className="col-md-3 col-lg-2 col-xl-2 offset-lg-1">
                                    <h5 className="mb-0">Rp.15.000,-</h5>
                                ...
                                <div className="col-md-1 col-lg-1 col-xl-1 text-end ">
                                    <a href="#!" className="text-danger"><i className="fas fa-trash fa-lg"><svg
                                                xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                fill="currentColor" className="bi bi-trash" viewBox="0 0 16 16">
                                                <path
                                                    d="M5.5 5.5A.5.5 0 0 1 6 6v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm2.5 0a.5.5 0 0 1 .5.5v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm3 .5a.5.5 0 0 0-1 0v6a.5.5 0 0 0 1 0V6z" />
                        ...
                        <div className="card-body p-4">
                            <div className="row d-flex justify-content-between align-items-center">
                                ...
                                <div className="col-md-3 col-lg-3 col-xl-3">
                                    ...
                                    <p><span className="text-muted">Size: </span>M <span className="text-muted">Color:
                                        </span>Grey</p>
                                </div>
                                <div className="col-md-2 col-lg-2 col-xl-2 d-flex">
                                    <button className="btn btn-link px-2"
                    ...
                    <div className="card">
                        <div className="card-body">
                            <button type="button" className="btn btn-warning btn-block btn-lg justify-content-end"><a href="#"
                                    className="text-decoration-none" style="color: #000;">Buat Pesanan</a></button>
                        </div>
                    </div>
